...
swagger_register = swagger_auto_schema(request_body=SwaggerRegister.req, responses=SwaggerRegister.res)
swagger_login = swagger_auto_schema(request_body=SwaggerLogin.req, responses=SwaggerLogin.res)
