...
class SwaggerGetArticleSwagger:
    params = [
...
swagger_get_article_list = swagger_auto_schema(security=[], manual_parameters=SwaggerGetArticleSwagger.params, responses=SwaggerGetArticleSwagger.res)
